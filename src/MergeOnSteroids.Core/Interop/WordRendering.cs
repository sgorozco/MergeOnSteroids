...
/// <summary>
/// Turns what Word drew into a picture a block can show. Word hands out its own
/// rendering of any range as an enhanced metafile; everything here is about
/// getting that onto screen without losing the typography.
/// </summary>
internal static class WordRendering
{
    /// <summary>
    ...
    /// </summary>
    internal static Bitmap TrimTrailingWhitespace(Bitmap source, int padding = 6)
    {
    ...
    internal static (double Width, double Height, double NativeDpi) PhysicalSize(Metafile metafile)
    {
        try
        {
